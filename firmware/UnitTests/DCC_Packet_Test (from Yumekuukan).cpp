...
//    CHECK_EQUAL(DCC_PACKET_IDLE_KIND, DCC_Packet_Get_Kind(&p));
//    CHECK_EQUAL(DCC_PACKET_IDLE_KIND, p.kind);
//}
//
...
//    p.data[1] = 0x00;
//    p.data[2] = 0x00;
//    CHECK_EQUAL(DCC_PACKET_RESET_KIND, DCC_Packet_Get_Kind(&p));
//    CHECK_EQUAL(DCC_PACKET_RESET_KIND, p.kind);
//}
//
///*********************/
//
...
//    p.data[1] = 0x41;
//    p.data[2] = p.data[1];
//    CHECK_EQUAL(DCC_PACKET_E_STOP_KIND, DCC_Packet_Get_Kind(&p));
...
//    CHECK_EQUAL(DCC_PACKET_SPEED_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//    CHECK_EQUAL(DCC_PACKET_ADVANCED_SPEED_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//}
//
//TEST(DCCPacketTests, GetKindRestrictedSpeedKind) {
//    p.size = 4;
//    p.data[0] = 0x00;
//    p.data[1] = 0x3E;
//    p.data[2] = 0x00;
//    p.data[3] = p.data[0] ^ p.data[1] ^ p.data[3];
//    CHECK_EQUAL(DCC_PACKET_RESTRICTED_SPEED_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//    CHECK_EQUAL(DCC_PACKET_HARD_RESET_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//    p.data[2] = 0x00;
//    p.data[3] = p.data[0] ^ p.data[1] ^ p.data[2];
//    CHECK_EQUAL(DCC_PACKET_NONE_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//}
//
//TEST(DCCPacketTests, GetKindDecoderSetAdvancedAddressing_RP921_L130) {
//    p.size = 4;
//    p.data[0] = 0x00;
//    p.data[1] = 0x0A;
//    p.data[2] = 0x00;
//    p.data[3] = p.data[0] ^ p.data[1] ^ p.data[2];
//    CHECK_EQUAL(DCC_PACKET_SET_ADVANCED_ADDRESSING_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//}
//
//TEST(DCCPacketTests, GetKindDecoderAckRequest_RP921_L132) {
//    p.size = 4;
//    p.data[0] = 0x00;
//    p.data[1] = 0x0E;
//    p.data[2] = 0x00;
//    p.data[3] = p.data[0] ^ p.data[1] ^ p.data[2];
//    CHECK_EQUAL(DCC_PACKET_ACK_REQUEST_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//    p.data[1] = 0x80;
//    p.data[2] = p.data[0] ^ p.data[1];
//    CHECK_EQUAL(DCC_PACKET_FUNC_FL_F4_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//    p.data[1] = 0xB0;
//    p.data[2] = p.data[0] ^ p.data[1];
//    CHECK_EQUAL(DCC_PACKET_FUNC_F5_F8_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//    p.data[1] = 0xA0;
//    p.data[2] = p.data[0] ^ p.data[1];
//    CHECK_EQUAL(DCC_PACKET_FUNC_F9_F12_KIND, DCC_Packet_Get_Kind(&p));
//}
//
//TEST(DCCPacketTests, GetKindBinaryStateLong_RP921_L271) {
//    p.size = 5;
//    p.data[0] = 0x00;
//    p.data[1] = 0xC0;
//    p.data[2] = 0x00;
...
//    CHECK_EQUAL(DCC_PACKET_BINARY_STATE_LONG_KIND, DCC_Packet_Get_Kind(&p));
//}
//
//TEST(DCCPacketTests, GetKindBinaryStateShort_RP921_L286) {
//    p.size = 5;
//    p.data[0] = 0x00;
//    p.data[1] = 0xDD;
//    p.data[2] = 0x00;
//    p.data[3] = p.data[0] ^ p.data[1] ^ p.data[2];
//    CHECK_EQUAL(DCC_PACKET_BINARY_STATE_SHORT_KIND, DCC_Packet_Get_Kind(&p));
//}
//
//TEST(DCCPacketTests, GetKindFuncGroupThree_RP921_L303) {
//    p.size = 5;
//    p.data[0] = 0x00;
//    p.data[1] = 0xDE;
//    p.data[2] = 0x00;
//    p.data[3] = p.data[0] ^ p.data[1] ^ p.data[2];
//    CHECK_EQUAL(DCC_PACKET_FUNC_F13_F20_KIND, DCC_Packet_Get_Kind(&p));
//}
//
//TEST(DCCPacketTests, GetKindFuncGroupFour_RP921_L315) {
//    p.size = 5;
//    p.data[0] = 0x00;
//    p.data[1] = 0xDF;
//    p.data[2] = 0x00;
//    p.data[3] = p.data[0] ^ p.data[1] ^ p.data[2];
//    CHECK_EQUAL(DCC_PACKET_FUNC_F21_F28_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//}
//
//TEST(DCCPacketTests, GetKindOpsModeShort_RP921_L338) {
//    p.size = 4;
//    p.data[0] = 0x00;
//    p.data[1] = 0xF0;
//    p.data[2] = 0x00;
//    p.data[4] = p.data[0] ^ p.data[1] ^ p.data[2];
//    CHECK_EQUAL(DCC_PACKET_OPS_MODE_SHORT_CONFIG_KIND, DCC_Packet_Get_Kind(&p));
//}
//
...
//    p.data[2] = 0x00;
//    p.data[4] = p.data[0] ^ p.data[1] ^ p.data[2];
//    CHECK_EQUAL(DCC_PACKET_OPS_MODE_LONG_CONFIG_KIND, DCC_Packet_Get_Kind(&p));
//}
//
