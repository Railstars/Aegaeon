...
uint8_t const PROGMEM _defaults[] = {
    ...
    0x01, // OUTPUT_LOCATION_FLF		33	//optional,		x,	RW, Uniform
    0x02, // OUTPUT_LOCATION_FLR		34	//optional,		x,	RW, Uniform
    ...
    0x10, // OUTPUT_LOCATION_FL9		43	//optional,		x,	RW, Uniform
    0x20, // OUTPUT_LOCATION_FL10	44	//optional,		x,	RW, Uniform
    0x40, // OUTPUT_LOCATION_FL11	45	//optional,		x,	RW, Uniform
    0x80, // OUTPUT_LOCATION_FL12	46	//optional,		x,	RW, Uniform
    ...
    0xFF, // MANUFACTURER_UNIQUE_58			58
...
static inline void _load_short_address(void)
{
...
//            return 0;
        ...
        if ((CV_temp == 20) || (CV_temp == 26) || (CV_temp == 28) || ((CV_temp >= 96) && (CV_temp <= 104)) ||  (CV_temp == CV_MANUFACTURER_VERSION) ||  (CV_temp > CV_USER_ID_2) ) //reserved ranges
            return;
